...
import '../../../my_coupon/presentation/cubit/my_coupon_cubit.dart';
import '../../../my_coupon/presentation/view/my_copoun_screen.dart';
              ...
              : SingleChildScrollView(
                  child: Column(
                    children: [
                          ...
                          child: Center(
                            child: Row(
                              children: [
                                ...
                                Expanded(
                                  child: CustomText(
                                    text: controller.userDataModel.user?.captain
                                            ?.balance ??
                                        "",
                                    textAlign: TextAlign.center,
                                    maxLine: 1,
                      ...
                      DrawerItem(
                        title: el.tr(AppStrings.myCopoun),
                        icon: IconsAssets.rateUs,
                        onTap: () {
                          Navigator.push(context,
                              MaterialPageRoute(builder: (context) {
                            return BlocProvider(
                              create: (_) => MyCopounCubit()..getMyCoupon(),
